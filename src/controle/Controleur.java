...
public class Controleur extends HttpServlet {
	...
	private static final String LISTER_OEUVRESVENTE = "listerOeuvresvente";
	...
	protected void processusTraiteRequete(HttpServletRequest request, HttpServletResponse response)
		...
		if (actionName.contains("modifierAdherent")) {

			int adherentId = Integer.parseInt(actionName.replaceAll("[\\D]", ""));

			try {

				Service unService = new Service();
				request.setAttribute("adherent", unService.consulterAdherent(adherentId));
				request.setAttribute("idAdherent", adherentId);
		...
		if (actionName.contains("updateAdherent")) {

			int adherentId = Integer.parseInt(actionName.replaceAll("[\\D]", ""));

			try {
				Adherent unAdherent = new Adherent();
				unAdherent.setIdAdherent(adherentId);
		...
		if (LISTER_OEUVRESVENTE.equals(actionName)) {
			try {
